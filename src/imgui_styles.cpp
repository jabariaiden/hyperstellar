...
void ImGuiStyles::SetupModernStyle() {
    ...
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.20f, 0.60f, 0.90f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.00f, 0.48f, 0.80f, 0.80f);
    ...
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.20f, 0.60f, 0.90f, 1.00f);
